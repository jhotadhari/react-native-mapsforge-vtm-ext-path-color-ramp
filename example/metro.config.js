 ...
 *
 * Previously provided by react-native-builder-bob/metro-config, which was
 * removed in react-native-builder-bob v0.43.0. Inlined here so the example
 * app doesn't depend on a bob subpath that no longer exists.
 *
