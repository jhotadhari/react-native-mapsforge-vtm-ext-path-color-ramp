...
To edit the Java or Kotlin files, open `example/android` in Android studio and find the source files at `react-native-mapsforge-vtm-ext-path-color-ramp` under `Android`.
